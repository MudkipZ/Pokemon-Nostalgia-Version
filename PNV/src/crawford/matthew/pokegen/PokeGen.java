...
public class PokeGen
{
	...
	public PokeGen(boolean derp)
	{
		...
		this.IVs[0]=31; this.IVs[1]=29; this.IVs[2]=31; this.IVs[3]=29; this.IVs[4]=31; this.IVs[5]=29;
		this.Level=50;
	}
	...
	{
		int HPStat=(int)(((float)this.Level/100)*(this.IVs[0]+(50)+(this.EVs[0]/4)+100))+10;
		int AtkStat=(int)(((this.Nature.getStatMods()[0]*(float)(this.Level)/100.0)*(70+this.IVs[1]+(this.EVs[1]/4))))+5;
		int DefStat=(int)(((this.Nature.getStatMods()[1]*(float)(this.Level)/100.0)*(140*2+this.IVs[2]+(this.EVs[2]/4))))+5;
		int SpAStat=(int)(((this.Nature.getStatMods()[2]*(float)(this.Level)/100.0)*(95*2+this.IVs[3]+(this.EVs[3]/4))))+5;
		int SpDStat=(int)(((this.Nature.getStatMods()[3]*(float)(this.Level)/100.0)*(110+this.IVs[4]+(this.EVs[4]/4))))+5;
		int SpeStat=(int)(((this.Nature.getStatMods()[4]*(float)(this.Level)/100.0)*(90+this.IVs[5]+(this.EVs[5]/4))))+5;
